import{j as d,p as V,q as R}from"./DebouncedInput-fe7e44fa.js";import{r}from"./index-f1f749bf.js";import{D as y,b as E,f as I,u as T,a as _,c as g}from"./fruits-e0a415da.js";import"./index-96c5f47c.js";import"./_commonjsHelpers-042e6b4d.js";import"./extends-98964cd2.js";const f=()=>({table:{disable:!0}}),z={title:"DataTable/DataTable Submit All",component:y,args:{config:{width:"100%",height:"100%",virtual:!1},sortConfig:{enableSorting:!0},header:{captionPadding:"1rem",tableCaption:"Fruits"},filters:{globalFilter:!0}},argTypes:{data:f(),columns:f(),table:f()}},x=E({}),b=t=>{const[o,i]=j(),[c,p]=r.useState(I),h=T({...t,meta:{updateData:(e,u,l)=>{i(),p(a=>a.map((s,n)=>n===e?{...a[e],[u]:l}:s))}},data:c,columns:[..._,{accessorKey:"unit",header:"Unit",cell:({getValue:e,row:u,column:l,table:a})=>{const s=e(),[n,D]=r.useState("");r.useEffect(()=>{D(s)},[s]);const[v]=g(x),C=u.id;return v[C]?d("input",{type:"text",value:n,onChange:m=>{D(m.target.value)},onBlur:()=>{var m,S;(S=(m=a.options)==null?void 0:m.meta)==null||S.updateData(u.index,l.id,n)}}):e()}},{id:"edit",cell:e=>{const[u,l]=g(x);return d("button",{onClick:()=>{l(a=>{const s=e.row.id,n=a[s]??!1;return{...a,[s]:!n}})},children:"edit"})}}]});return V(R,{children:[d(P,{table:h}),d(y,{...t,table:h})]})};function P({table:t}){const[o]=g(x);return d("button",{onClick:()=>{const i=Object.keys(o).reduce((c,p)=>(o[p]&&c.push(t.getRow(p).original),c),[]);console.log(i)},children:"Submit All"})}function j(){const t=r.useRef(!0),o=t.current,i=r.useCallback(()=>{t.current=!1},[]);return r.useEffect(()=>{t.current=!0}),[o,i]}var A,k,w;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`(props: any) => {
...
//# sourceMappingURL=DataTableRaw.stories-b0af0beb.js.map
