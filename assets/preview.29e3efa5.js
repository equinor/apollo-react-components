import{e as T,j as w,w as z,n as B,o as $,$ as M}from"./iframe.e7aa5b54.js";var f="backgrounds",{document:s,window:H}=z,L=()=>H.matchMedia("(prefers-reduced-motion: reduce)").matches,S=(r,e=[],t)=>{if(r==="transparent")return"transparent";if(e.find(n=>n.value===r))return r;let a=e.find(n=>n.name===t);if(a)return a.value;if(t){let n=e.map(i=>i.name).join(", ");T.warn(w`
  ...
  `),X=(r,e)=>{var h,v,y,k;let{globals:t,parameters:a}=e,n=a[f].grid,i=((h=t[f])==null?void 0:h.grid)===!0&&n.disable!==!0,{cellAmount:o,cellSize:u,opacity:l}=n,c=e.viewMode==="docs",d;(v=a.grid)!=null&&v.cellSize?(d=a.grid.cellSize,R()):d=u;let p=a.layout===void 0||a.layout==="padded"?16:0,g=(y=n.offsetX)!=null?y:c?20:p,m=(k=n.offsetY)!=null?k:c?20:p,x=$(()=>{let b=e.viewMode==="docs"?`#anchor--${e.id} .docs-story`:".sb-show-main",E=[`${d*o}px ${d*o}px`,`${d*o}px ${d*o}px`,`${d}px ${d}px`,`${d}px ${d}px`].join(", ");return`
      ${b} {
...
//# sourceMappingURL=preview.29e3efa5.js.map
